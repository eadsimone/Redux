import { createReducer, CaseReducer } from '@reduxjs/toolkit/src/createReducer'
import { PayloadAction, createAction } from '@reduxjs/toolkit/src/createAction'
import { createNextState, Draft } from '@reduxjs/toolkit/src/index'
...
describe('createReducer', () => {
  ...
  describe('Immer in a production environment', () => {
    ...
    test('Freezes data in production', () => {
      const { createReducer } = require('@reduxjs/toolkit/src/createReducer')
      const addTodo: AddTodoReducer = (state, action) => {
        const { newTodo } = action.payload
        state.push({ ...newTodo, completed: false })
      }
